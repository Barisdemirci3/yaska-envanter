              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><button title="Düzenle" class="btn purple-button"  name="status_edit" data-id="<?= $row["durum_id"]; ?>"><i class="fa-solid fa-pen-to-square"></i></button> <button data-id="<?= $row["durum_id"] ?>" title="Sil" name="sil-status" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
